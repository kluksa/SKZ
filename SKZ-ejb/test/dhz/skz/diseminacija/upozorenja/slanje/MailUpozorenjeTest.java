 ...
 * @author kraljevic
 */
public class MailUpozorenjeTest {
    Collection<Podatak> podaci; 
    ProgramMjerenja program;
    Obavijesti obavijest;
    
    public MailUpozorenjeTest() {
    }
    ...
    public void setUp() {
        ...
        program = new ProgramMjerenja();
        program.setPostajaId(postaje[1]);
        program.setKomponentaId(komponente[2]);
        ...
        kp.setOpis("probna granica");
        kp.setOznaka("PG");
        g.setKategorijeGranicaId(kp);
        g.setKomponentaId(program.getKomponentaId());
    ...
    /**
     * Test of saljiUpozorenje method, of class MailUpozorenje.
     */
    @Test
