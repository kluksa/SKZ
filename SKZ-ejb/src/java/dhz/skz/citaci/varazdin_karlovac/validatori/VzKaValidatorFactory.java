 ...
 * @author kraljevic
 */
public class VzKaValidatorFactory extends ValidatorFactory {
    private final Validator validator;

    public VzKaValidatorFactory(Collection<ProgramMjerenja> programi) {
        super(programi);
        this.validator = new VzKaValidator();
    }
